...
class SparseConvolution(SparseModule):
    ...
    def forward(self, input):
        """
        self.weight.shape: [ks, ks, ks, C_in, C_out] 
        """
        ...
        '''
        print('===========> in spconv, self.indice_key:', self.indice_key)
        print('===========> datas is None: ', (datas is None))
        print(input.grid)
        if input.grid is not None:
            print('==> input.grid.shape', input.grid.shape) # 好像都是None
        '''
        if self.inverse:
            assert datas is not None 
            assert self.indice_key is not None
            ...
            if self.indice_key is not None and datas is not None:
                ...
                input.indice_dict[self.indice_key] = (outids, indices,
                                                      ...
                                                      spatial_shape)
            """
            print('==> conv outids.shape: ', outids.shape)
            print('==> conv outids: ', outids) 
            # 这个就是return的tensor的indices
            print('==> conv indice_pairs.shape: ', indice_pairs.shape)
            print('==> conv indice_pairs: ', indice_pairs)
            ...
            print('==> conv indice_pair_num: ', indice_pair_num)
