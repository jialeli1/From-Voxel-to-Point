...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("indice_group_fp32", &spconv::indiceGroup<float>, "indice_group_fp32");
  m.def("indice_group_backward_fp32", &spconv::indiceGroupBackward<float>,
        "indice_group_backward_fp32");
