...
class UNetV2(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        # print('==> x_up4.spatial_shape: ', x_up4.spatial_shape) 
        # x_up4.spatial_shape:  [11, 400, 352]
        # print('==> x_up4.features.shape: ', x_up4.features.shape)
        # c=64

        # [800, 704, 21] <- [400, 352, 11]
        x_up3 = self.UR_block_forward(x_conv3, x_up4, self.conv_up_t3, self.conv_up_m3, self.inv_conv3)
        # print('==> x_up3.spatial_shape: ', x_up3.spatial_shape)
        # x_up3.spatial_shape:  [21, 800, 704]
        # print('==> x_up3.features.shape: ', x_up3.features.shape)
        # c=32

        # [1600, 1408, 41] <- [800, 704, 21]
        x_up2 = self.UR_block_forward(x_conv2, x_up3, self.conv_up_t2, self.conv_up_m2, self.inv_conv2)
        # print('==> x_up2.spatial_shape: ', x_up2.spatial_shape)
        # x_up2.spatial_shape:  [  41 1600 1408]
        # print('==> x_up2.features.shape: ', x_up2.features.shape)
        # c=16
        
        # [1600, 1408, 41] <- [1600, 1408, 41]
        x_up1 = self.UR_block_forward(x_conv1, x_up2, self.conv_up_t1, self.conv_up_m1, self.conv5)
        # print('==> x_up1.spatial_shape: ', x_up1.spatial_shape)
        # x_up1.spatial_shape:  [  41 1600 1408]
        # print('==> x_up1.features.shape: ', x_up1.features.shape)
        # c=16
