...
if __name__ == '__main__':
    ...
    setup(
        ...
        ext_modules=[
            make_cuda_ext( # added by ljl, from mmdetection3d
            ...
            make_cuda_ext(
                ...
                sources=[
                    ...
                    'src/voxel_query.cpp', # added by ljl, from voxel-rcnn
                    'src/voxel_query_gpu.cu', # added by ljl, from voxel-rcnn
                ],
            ),
            make_cuda_ext(
